...
const MiddlePart = () => {
  ...
  return (
    <div className='px-5'>
      <section className="flex items-center justify-center p-3 rounded-b-md">
    ...
    <Avatar/>
    <input readOnly className='outline-none w-[100%] rounded-full px-5 bg-transparent border-[#3b4054] border' type='text'></input>
        </div>
